...
// Типы для двухуровневого хранения сообщений
export interface TwoLevelStorage {
  recentMessages: ChatMessage[];  // Последние N сообщений
  summary: string;                 // Саммари более старых сообщений
  totalMessageCount: number;       // Общее количество сообщений
}
